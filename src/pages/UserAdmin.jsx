      ...
      {isDrawerOpen && (
        <>
          ...
          <div className="fixed inset-y-0 right-0 w-full max-w-xl bg-white z-50 shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <form className="p-8 overflow-y-auto flex-1 space-y-8 bg-white">
              {/* OWNER SECTION */}
              <div className="space-y-4">
                <SectionTitle icon={<User size={16}/>} title="Owner Information" />
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Input label="Full Name" defaultValue={currentUser?.ownerName} required />
                  <Input label="Phone Number" defaultValue={currentUser?.ownerPhone} required />
                  <div className="md:col-span-2">
                    <Input label="Email Address" type="email" defaultValue={currentUser?.ownerEmail} />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div className="col-span-2 md:col-span-1">
                    <Input label="License Plate" defaultValue={currentUser?.vehicleNumber} required />
                  </div>
                  <Input label="Brand" defaultValue={currentUser?.brand} required />
                  <Input label="Model" defaultValue={currentUser?.model} required />
                  <Input label="Variant" placeholder="e.g. VXI / Luxury" defaultValue={currentUser?.variant} />
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Input label="Chassis Number" defaultValue={currentUser?.chassisNumber} />
                  <Input label="Engine Number" defaultValue={currentUser?.engineNumber} />
                  <Input label="Body Color" defaultValue={currentUser?.color} />
                  <Input label="Manufacturing Year" type="number" defaultValue={currentUser?.year} />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1">
                  <Input label="Last Service Date" type="date" defaultValue={currentUser?.lastServiceDate ? new Date(currentUser.lastServiceDate).toISOString().split('T')[0] : ''} />
                </div>
              </div>
            </form>
            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50 flex gap-3">
              ...
              <button className="flex-[2] bg-indigo-600 text-white py-3 rounded-2xl font-bold flex items-center justify-center gap-2 hover:bg-indigo-700 transition-all active:scale-95 shadow-lg shadow-indigo-100">
