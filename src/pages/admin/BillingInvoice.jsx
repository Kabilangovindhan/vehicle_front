...
// ================= REFINED INVOICE MODAL =================

function InvoiceModal({ estimate, onClose }) {
    ...
    const handleConfirmBill = async () => {
        ...
        if (!window.confirm("Are you sure you want to finalize this bill?")) return;
        ...
        try {
            const res = await fetch("http://localhost:5000/api/adminBillingInvoice/confirm-bill", {
                ...
                body: JSON.stringify({
                    ...
                    paymentMethod: "Cash" // You could add a dropdown for this later
                })
            });
            ...
            if (res.ok) {
                ...
                onRefresh(); // Refresh the main queue
            ...
            alert("System error during billing");
        }
    };
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:p-6">
            ...
            >
                ...
                <div className="flex-1 p-6 overflow-y-auto space-y-6 custom-scrollbar">
                    {/* Info Card */}
                    <div className="bg-slate-900 rounded-[1.5rem] p-6 text-white grid grid-cols-2 gap-4 shadow-lg shadow-slate-200">
                        <div>
                        ...
                        <div className="text-right">
                            ...
                            <p className="font-bold text-lg text-emerald-400 tracking-wider leading-tight">
                                {formData.job?.booking?.vehicle?.vehicleNumber}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between items-end px-1">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 text-xs font-bold px-4 py-2 rounded-xl transition-all border ${isEditing ? "bg-emerald-50 border-emerald-200 text-emerald-700" : "bg-white border-slate-200 text-slate-600 hover:bg-slate-50"
                                }`}
                        >
                    ...
                    <div className="space-y-3">
                        {formData.items.map((item, i) => (
                            <div key={i} className="group border border-slate-200 rounded-2xl p-4 transition-all hover:border-slate-300 bg-white">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-7 pr-3 py-2 bg-slate-50 border-transparent border rounded-xl focus:bg-white focus:border-emerald-500 transition-all outline-none disabled:opacity-70 font-medium"
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-1">
                ...
                <div className="p-6 border-t border-slate-100 bg-slate-50/80 backdrop-blur-md">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 bg-slate-900 text-white rounded-2xl py-3.5 font-black hover:bg-emerald-600 transition-all active:scale-95 shadow-lg shadow-slate-200"
                        >
                            CONFIRM & BILL
                        </button>
                    </div>
