...
function CustomerInvoice() {
    ...
    // ✅ Get phone from sessionStorage (stored during login)
    ...
    const fetchInvoices = async () => {
        try {
            const res = await fetch(
                `http://localhost:5000/api/customerInvoice/invoices/${phone}`
            );
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/40">
            ...
            >
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <p><strong>Brand:</strong> {invoice.job?.booking?.vehicle?.brand}</p>
                    <p><strong>Model:</strong> {invoice.job?.booking?.vehicle?.model}</p>
