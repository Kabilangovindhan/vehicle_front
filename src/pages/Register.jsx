	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			if (response.ok) {
				...
				setFormData({ fullName: "", email: "", phone: "", altPhone: "", address: "", password: "" });
			} else {
				...
				<div className="flex-1 p-8 sm:p-14 md:p-20 bg-white">
					...
					<footer className="mt-12 text-center">
						<p className="text-slate-400 font-bold text-sm">
							Already a partner?
							<a href="/login" className="ml-2 text-blue-600 hover:text-slate-900 transition-colors border-b-2 border-transparent hover:border-slate-900">Sign In</a>
						</p>
					</footer>
				</div>
			</div>
