  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `http://localhost:5000/api/serviceUpdate/jobs?status=${activeTab}`
      );
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm font-medium">
                ...
                Monitor vehicle service progress and delivery readiness
          ...
          {tabs.map(tab => (
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-black transition-all ${
                activeTab === tab.id
                  ? `${tab.bg} ${tab.color} ring-2 ring-indigo-200`
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl p-16 text-center border border-slate-100 shadow-sm">
            ...
            <p className="text-slate-500 mt-1">
              ...
              There are no jobs currently in "{activeTab}" status.
                  ...
                  {jobs.map(job => (
                    ...
                    <tr key={job._id} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="px-6 py-5">
                        ...
                        <span className={`inline-flex items-center px-3 py-1 border rounded-full text-[10px] font-black uppercase ${getStatusStyles(job.jobStatus)}`}>
