...
function Layout() {
    ...
    const menuConfigs = {
        ...
        STAFF: [
            ...
            { path: "/layout/approval-queue", label: "Approval Queue", icon: ClipboardCheck },
    ...
    const navClass = ({ isActive }) => `flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-300 group ${isActive ? "bg-gradient-to-r from-indigo-600 to-indigo-600 text-white shadow-lg shadow-indigo-900/30" : "text-indigo-200/70 hover:bg-indigo-800/50 hover:text-white"}`;
            ...
            >
                <div className="p-8 mb-2">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-indigo-300">AutoCare</h1>
                ...
                <nav className="flex-1 px-6 space-y-3 overflow-y-auto sidebar-scroll">
                    ...
                    <button onClick={handleLogout} className="flex w-full text-[13px] items-center gap-3 px-4 py-2 text-xs text-indigo-300 hover:text-red-300 transition-colors">
                        <LogOut size={18} />
